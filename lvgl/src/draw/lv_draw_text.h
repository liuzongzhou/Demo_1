...
#ifndef LV_DRAW_TEXT_H
#define LV_DRAW_TEXT_H
 ...
 *      DEFINES
 *********************/
#define LV_DRAW_TEXT_NO_TXT_SEL (0xFFFF)
...
typedef struct _lv_draw_text_hint_t {
 ...
 */
void /* LV_ATTRIBUTE_FAST_MEM */ lv_draw_text(struct _lv_draw_ctx_t * draw_ctx, const lv_draw_text_dsc_t * dsc,
                                               const lv_area_t * coords, const char * txt, lv_draw_text_hint_t * hint);

/*void lv_draw_letter(struct _lv_draw_ctx_t * draw_ctx, const lv_draw_text_dsc_t * dsc,  const lv_point_t * pos_p,
                    uint32_t letter);*/
