...
# define SDL_ZOOM_X             MONITOR_ZOOM_X
# define SDL_ZOOM_Y             MONITOR_ZOOM_Y
...
static void window_create(monitor_t * m)
{
    ...
    m->window = SDL_CreateWindow("TFT Simulator",
                              ...
                              SDL_HOR_RES * SDL_ZOOM_X, SDL_VER_RES * SDL_ZOOM_Y, flag);       /*last param. SDL_WINDOW_BORDERLESS to hide borders*/
    ...
    switch(event->type) {
        ...
        case SDL_MOUSEBUTTONDOWN:
            if(event->button.button == SDL_BUTTON_LEFT) {
                ...
                last_x = event->motion.x / SDL_ZOOM_X;
                last_y = event->motion.y / SDL_ZOOM_Y;
            }
            break;
        ...
        case SDL_FINGERUP:
            left_button_down = false;
            last_x = LV_HOR_RES * event->tfinger.x / SDL_ZOOM_X;
            last_y = LV_VER_RES * event->tfinger.y / SDL_ZOOM_Y;
            break;
        case SDL_FINGERDOWN:
            left_button_down = true;
            last_x = LV_HOR_RES * event->tfinger.x / SDL_ZOOM_X;
